...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 The named payload skill is deregistered and the command prints that the SKILL.md was left at payload/agent-skills/name/ for the author to delete deliberately.
...
- [ ] #4 Run outside any project it exits non-zero naming the missing manifest.yml and suggesting init or the -C override; the name completes from registered payload skills.
