...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 The reference is deregistered and the command prints that the file was left at installer-scripts for the author to delete deliberately.
...
- [ ] #4 Run outside any project it exits non-zero naming the missing manifest.yml and suggesting init or the -C override; the path completes from registered installer-scripts.
